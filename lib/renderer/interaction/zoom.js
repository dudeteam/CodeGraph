...
dudeGraph.Renderer.prototype._createZoomBehavior = function () {
    ...
    this._zoomBehavior = d3.behavior.zoom()
        ...
        .on("zoom", function () {
            ...
            if (renderer._zoom.translate[0] !== d3.event.translate[0] || renderer._zoom.translate[1] !== d3.event.translate[1]) {
                zoomed = true;
            }
        ...
        .on("zoomend", function () {
            if (!zoomed && (!isNaN(d3.mouse(this)[0]) || !isNaN(d3.mouse(this)[1]))) {
                renderer.emit(
                    "autocomplete",
                    d3.mouse(renderer._d3Root.node()),
